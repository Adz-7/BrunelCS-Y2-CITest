 ...
 event.preventDefault()
      ...
      render() {
       ...
       <div className="cardSection">
            <EventsCard
                title = {this.cardstate.card1title}
                imageUrl= {this.cardstate.card1imageurl}
                body = {this.cardstate.card1body}
                button = "Learn More"
                location = {this.cardstate.card1location}
                date = {this.cardstate.card1date}
                time = {this.cardstate.card1time}
            />
            <EventsCard
                title = {this.cardstate.card2title}
                imageUrl= {this.cardstate.card2imageurl}
                body = {this.cardstate.card2body}
                button = "Learn More"
                location = {this.cardstate.card2location}
                date = {this.cardstate.card2date}
                time = {this.cardstate.card2time}
            />
            <EventsCard
                title = {this.cardstate.card3title}
                imageUrl= {this.cardstate.card3imageurl}
                body = {this.cardstate.card3body}
                button = "Learn More"
                location = {this.cardstate.card3location}
                date = {this.cardstate.card3date}
                time = {this.cardstate.card3time}
            />
        </div>
        <div>
        ...
        <div className="box1">
            <form onSubmit={this.handleSubmit}>
                ...
                <label>Organisation :</label> <input type="text" value={this.state.organisation} onChange={this.organisationhandler} placeholder="Organisation..." /><br />
                <label>Location :</label> <input type="text" value={this.state.location} onChange={this.locationhandler} placeholder="Location..." /><br />
                <label>Details :</label> <input type="details" value={this.state.details} onChange={this.detailshandler} placeholder="Details..." /><br />
                <label>Date :</label> <input type="date" value={this.state.date} onChange={this.datehandler} placeholder="Date" /><br />
                <label>Time :</label> <input type="time" value={this.state.time} onChange={this.timehandler} placeholder="Time" /><br />      
            <br />
